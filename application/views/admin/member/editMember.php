            ...
            <form action="<?= base_url('member/update') ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_member" class="form-control" placeholder="Nama member"
                        id="nama_member" value="<?= $member['nama_member'] ?>">
                </div>
                <div class="form-group">
                    <label for="no_telp" class="form-label">Nomor Telepon</label>
                    <input type="number" name="no_telp" class="form-control" value="<?= $member['no_telp'] ?>"
                        placeholder="Nomor Telepon" id="no_telp">
                </div>
                <div class="form-group">
                    <label for="exp" class="form-label">Exp</label>
                    <input type="date" name="exp" class="form-control" placeholder="Exp" value="<?= $member['exp'] ?>"
                        id="exp">
                </div>
